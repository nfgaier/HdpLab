...
CID_namenode=$(docker run -d --dns 127.0.0.1 --privileged=true -p 8080:8080 -p 8440:8440 -p 8441:8441 -p 50070:50070 -p 50075:50075 -p 8020:8020 -p 1111:22 -e NODE_TYPE=namenode --name node1 -h node1 -i -t hdp/master-node)
